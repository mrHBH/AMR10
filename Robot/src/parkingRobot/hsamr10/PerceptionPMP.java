...
import parkingRobot.hsamr10.PerceptionThread;
...
public class PerceptionPMP implements IPerception {
	...
	public int getRightRough(){ return this.RightLineSensor;}
...
//		monitor.writePerceptionComment("Perception");
	...
	public int getLSlblackValue(){
		return this.LSlblack;
	}
